...
public class TelefonoMovil implements IObservable, IObserver{

    private String numero;
    private ArrayList<IObserver> suscritos;

    public TelefonoMovil(String correo) {
        this.numero = correo;
    ...
    public void update(IObserver origen, IObserver quien) {
        System.out.println("Mensaje al movil, en " + origen.getIdentificador() + ", se ha recibido " +
